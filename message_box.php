...
?>
				...
				<li><button class="active" onclick="location.href='message_box.php?mode=send'">송신 쪽지함</button></li>
<?php
	} else {
?>
				<li><button class="active" onclick="location.href='message_box.php?mode=rv'">수신 쪽지함</button></li>
